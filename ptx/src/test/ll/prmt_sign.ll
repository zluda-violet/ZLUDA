define amdgpu_kernel void @prmt_sign(ptr addrspace(4) byref(i64) %"36", ptr addrspace(4) byref(i64) %"37") #0 {
...
"35":                                             ; preds = %1
  ...
  %4 = extractelement <4 x i8> %2, i32 3
  %5 = icmp slt i8 %4, 0
  %6 = sext i1 %5 to i8
  %7 = insertelement <4 x i8> %2, i8 %6, i32 3
  %8 = extractelement <4 x i8> %3, i32 3
  %9 = icmp slt i8 %8, 0
  %10 = sext i1 %9 to i8
  %11 = insertelement <4 x i8> %3, i8 %10, i32 3
  %"55" = shufflevector <4 x i8> %7, <4 x i8> %11, <4 x i32> <i32 4, i32 0, i32 6, i32 0>
